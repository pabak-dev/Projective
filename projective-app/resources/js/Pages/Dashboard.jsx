            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        ...
                        />
                        <StatCard
                            icon={<StarIcon className="w-6 h-6 text-gray-600" />}
                            title="Your Rank"
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className="bg-white p-6 rounded-xl shadow-md">
                                ...
                                <ul className="space-y-3">
                                    {myTasks.length > 0 ? (
                                        myTasks.map(task => (
                                            <li key={task.id} className="flex justify-between items-center text-sm p-3 rounded-lg transition-colors hover:bg-gray-50">
                                                <div>
                                        ...
                                        <p className="text-sm text-gray-500 text-center py-4">
                                            No pressing tasks assigned to you. Great job!
                                        </p>
                                    )}
                                </ul>
                            </div>
                                ...
                                {leaderboard.topUsers.map((user, index) => (
                                    <li key={user.id} className="flex items-center justify-between text-sm p-2 rounded-lg">
                                        <div className="flex items-center">
                                            <span className="font-bold text-base text-gray-400 w-6 text-center">{index + 1}</span>
                                            <img
